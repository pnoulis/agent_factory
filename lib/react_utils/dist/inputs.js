...
function S(e = {}) {
  ...
  return [
    ...
    (s, ...l) => {
      ...
      else if (Object.hasOwn(g, s)) n(g[s](...l));
      else throw new Error(`Undefined action:${s} in formReducer`);
    },
  ];
}
function y(e, t) {
...
const g = {
  ...
  m = () => {
    ...
    if (e == null) throw new Error("<FormProvider/> missing");
    return e;
  },
  k = ({ value: e, children: t }) =>
    /* @__PURE__ */ o.createElement(v.Provider, { value: e }, t),
  h = {
    fields: {},
    errors: {},
    submitting: !1,
  ...
  z = o.forwardRef(function (
    ...
    return /* @__PURE__ */ o.createElement(
      ...
      /* @__PURE__ */ o.createElement(
        "label",
        { className: "label", htmlFor: r },
        globalThis.t(s) || globalThis.t(r),
      ),
      i[r]
        ? null
        : /* @__PURE__ */ o.createElement(
...
function C({
  ...
  return /* @__PURE__ */ o.createElement("textarea", {
    error: d[n],
    id: n,
    form: x,
    className: e || "",
