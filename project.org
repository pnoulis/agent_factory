...
#+begin_src js
  {
    ok: true,
    cashiers: backend.response.cashiers
  }
#+end_src
...
** TODO Implement Cashier registration
*** TODO Normalize
*** DONE Object schema for req/res backend topic payload
*** DONE Implement backend api topic call
*** DONE Implement Task and Command
...
#+begin_src js
  ...
  res: {
    cashier: {
      username: '4b2k414jjnm',
      email: 'Saruman@gmail.com',
      password: '2u85h819i62',
      role: ["ROLE_CASHIER"],
      id: 28
    }
  }
...
** TODO Implement Cashier deregistration
*** TODO Normalize
*** DONE Object schema for req/res backend topic payload
*** DONE Implement backend api topic call
*** DONE Implement Task and Command
...
**** Afm response
#+begin_src js
  // ctx.res = ctx.args.cashier
  // resolve -> ctx.res
#+end_src
** TODO Implement Cashier login
*** DONE Object schema for req/res backend topic payload
*** DONE Implement backend api topic call
*** DONE Implement Task and Command
*** DONE Document the req/res payload
