...
#+end_src
**** No Normalization
** DONE Implement list Scoreboard Devices
...
#+end_src
**** No Normalization
** DONE ImpLement list Scoreboard
...
** DONE Implement Device shutdown
*** DONE Object schema for req/res backend topic payload
*** DONE Implement backend api topic call
*** DONE Implement Task and Command
*** DONE Document the req/res payload
...
#+end_src
** DONE Implement Cashier de-registration
*** DONE Object schema for req/res backend topic payload
*** DONE Implement backend api topic call
*** DONE Implement Task and Command
*** DONE Document the req/res payload
