...
* Task Board
** TODO Optional Label in forms should move when error
** Production optimizations
*** Remove unused imports
https://www.npmjs.com/package/eslint-plugin-unused-imports
*** No debug statements
*** Generally eliminate uneccessary code
*** Remove unusude files
** Per page final touches
*** Login Cashier
**** Page and Content?
**** ViewCommand
**** Command messages?
**** parsecmd to parse()?
*** Register player
**** DONE Page and Content?
**** DONE View command
**** DONE Command messages?
**** DONE parsecmd to parse()?
*** Pair wristband
**** DONE Page and Content?
**** DONE View command
**** DONE Command messages?
...
** Show the result of commands

_AwaitCommand_
Every time a new Command is initiated I must display to the User its progress
and the message comunicating the result of the Command. Specifically, The
Command should not produce any change in the component tree.

_ViewCommand_
Other times I do want to have a descendant component tree tied to the Command
States and Result.

** Group party
*** On merge
I should run the pre-register tests on each team.
I should gather all errors.
And then I should display them on an alert.

If there are teams that pass the tests, they should be registered.
The results of each pending registration should be kept so that
at the end of the process i can show the results in an Alert list.

*** On distribution
**** DONE The teams that have been registered should remain intact
CLOSED: [2024-02-26 Mon 13:54]
*** TODO TeamActionCard
should be declared as either a grouparty team or normal team
*** DONE On pair wristband
CLOSED: [2024-02-26 Mon 14:49]
If the cashier initiates a pair wristband event for a player other than the one
currently being paired the registration queue should switch pairing from the old
player to the new player.
** TODO Cover the case where a user navigates to a non existent team page
notify using an alert
then navigate to live view

** page group party
cannot re-distribute of if there is a merged team
...
#+begin_src js
  {
    ...
    #+end_src
** Implement Session stop force
**** Backend request
**** Backend response
#+begin_src js
  {
    timestamp: 1708773569466,
    result: 'OK',
    message: 'False'
  }
#+end_src
...
* Pages
** DONE ./pages/cashiers/PageIndex.jsx
** DONE ./pages/cashiers/PageRegister.jsx
** DONE ./pages/cashiers/PageLogin.jsx
** DONE ./pages/players/PagePairWristband.jsx
** DONE ./pages/players/PageRegister.jsx
** ./pages/devices/PageDevices.jsx
** ./pages/team/PageTeam.jsx
** ./pages/team/PageRegister.jsx
* Schemas
** Package
*** AFM Time
#+begin_src js
